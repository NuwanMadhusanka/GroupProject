    	...
    	<div class="row" id="content">
    		...
    		<%@ include file="../WEB-INF/templates/msg.jsp" %>
	    		...
	    		<div class="jumbotron">
	    			...
	    			String sql="SELECT * FROM user,staff,administrative_staff WHERE "+
	    					   "user.emp_id=staff.emp_id AND user.emp_id=administrative_staff.emp_id AND user.id=?";
	    			...
	    			<form action="../adminstaff_edit_action" method="post">
					  ...
					  <div class="form-group">
						  ...
						  <textarea class="form-control" rows="3" name="qualification"><%=qul %></textarea>
					  </div>

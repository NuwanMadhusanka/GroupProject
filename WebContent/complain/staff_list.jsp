	    	...
	    	<div class="row" id="content">
	    		...
	    		<div class="container">
	    			<div class="jumbotron">
	    				...
	    				<table class="table">
	    					<caption>Complain Details(Reply)</caption>
	    					<tr>
	    						<th>Title</th>
	    						<th>Option</th>
	    					</tr>
	    						...
	    						String sql="SELECT complain.cmp_id,complain.title "+
	    						...
	    						<td><%=title%></td>
	    						<td>
									<a href="staff_listadvance.jsp?id=<%=cmpId %>" class="btn btn-info"><i class="fas fa-eye" title="Advanced"></i></a>
	    						</td>
	    						</tr>
	    						<%} %>
	    				</table>
	    				...
	    				<table class="table">
	    					<caption>Complain Details(Not Reply)</caption>
	    					<tr>
	    						<th>Title</th>
	    						<th>Option</th>
	    					</tr>
